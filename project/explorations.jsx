...
// 400ms hold picks up the block: it tilts -2.5°, lifts on a shadow, and offsets
// up + right so the user can see the dotted target's top-left + bottom-left
// corners. The dotted ghost rides under the cursor at the snap-locked
// position; a "+X min" pill confirms what changed.
function ExploreCalendarDrag() {
...
Object.assign(window, { ExploreDragState, ExploreBlockDetail, ExploreFocusMobile, ExploreFocusDesktop, ExploreCalendarDrag });
