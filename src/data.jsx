...
export const STATUS_LABEL = { todo: 'To do', doing: 'Doing', review: 'Review', done: 'Done' };
export const DAYS = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
export const PROJECTS = ['Research', 'Design', 'Engineering', 'Routine', 'Personal'];
...
export function layoutList(dims, opts = {}) {
...
export function layoutKanban(dims, opts = {}) {
  const cols = STATUSES;
...
export function layoutCalendar(dims, opts = {}) {
...
export function layoutGantt(dims, opts = {}) {
  const days = DAYS.length;
