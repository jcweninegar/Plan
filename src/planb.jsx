...
export function BScreenExpanded() {
  return (
    <BScreenFrame active="home">
      <BBlockRow title="Routines" viewType="kanban" />
...
export function BScreenDrillIn() {
  return (
...
export function BScreenCalendar() {
